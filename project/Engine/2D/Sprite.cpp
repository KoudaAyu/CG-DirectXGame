...
void Sprite::Update(DebugCamera* debugCamera, WindowAPI* windowAPI)
{
	IndexDataCreate();
	VertexDataCreate();
	...
	Matrix4x4 worldViewProjectionmatrixSprite = Multiply(worldMatrixSprite, Multiply(debugCamera->GetViewMatrix(), projectionMatrixSprite));
