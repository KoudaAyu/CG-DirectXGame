...
void ParticleManager::CreateGraphicsPipeline()
{
	...
	// Create the actual PSO on the device using the prepared desc
...
void ParticleManager::InitializeGraphicPipeline()
{
	...
	// Depth disabled for particles (no DSV format)
	graphicPipelineStateDesc.DepthStencilState = {};
	graphicPipelineStateDesc.DepthStencilState.DepthEnable = FALSE;
	graphicPipelineStateDesc.DSVFormat = DXGI_FORMAT_UNKNOWN;
}
