...
> **【要約】開発中の3Dアクションシューティングゲームにおける、ゲームプレイとAIシステム（対角OBBマルチコライダー、トンネル現象を防ぐ連続線分CCD判定、レーザー照準同期、敵AI의カバー・捜索・巡回行動、およびAABBツリー階層構造による計算最適化）の実証とスケジュール資料です。**
...
* **📄 [ゲーム・AI技術スライド資料 [簡易版] (PDF)](sega_gameplay_interaction_slides.pdf)** （※Marpエクスポート用・簡易版）
