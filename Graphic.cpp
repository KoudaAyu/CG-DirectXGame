...
void Graphic::CreateGraphicPipelineState(const Microsoft::WRL::ComPtr<ID3D12RootSignature>& rootSignature,
	...
	const D3D12_RASTERIZER_DESC& rasterizerDesc)
{
	...
	graphicPipelineStateDesc.BlendState = blend; //ブレンドステートの設定
